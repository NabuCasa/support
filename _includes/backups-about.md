<!--- About backup. Applies to both Home Assistant Green and Yellow. -->
...
A backup includes your system configuration, app data, automations, scripts, and media stored on Home Assistant.