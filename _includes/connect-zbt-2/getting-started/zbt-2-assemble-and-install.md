<!---steps on assembling, finding a location, and installing Home Assistant Connect ZBT-2. -->


{% step "Find a good location." %}
{% image "/static/img/connect-zbt-2/zbt-2-find-location-step.png" "Image showing objects that cause interference or block signals, such as walls, body of water, wireless transmitters, or wire mesh" %}
{% stepContent %}
