...
Firmware updates for the Connect&nbsp;ZBT-1 are natively supported in Home Assistant 2025.4 and newer if you are running the {% abbr "ZHA" %} integration or {% abbr "OTBR" %}:
