---
zendesk:
  article_id: 31347057208989
  name: Switching from Zigbee to Thread support on Home Assistant Connect ZBT-2
  position: 20
...
{% steps %}
{% prereq %}
{% image "/static/img/connect-zbt-2/connect-zbt-2-zha-setup.png" "Screenshot showing the Zigbee integration page" %}
{% stepContent %}
...
{% image "/static/img/connect-zbt-2/zbt-2-switch-to-thread.png" "Select the Thread firmware" %}
{% stepContent %}
...
2. Select the **Thread** integration, then select the cogwheel.
   - You now see a **Home Assistant OpenThread Border Router**.
