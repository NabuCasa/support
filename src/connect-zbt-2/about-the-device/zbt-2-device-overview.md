---
zendesk:
  article_id: 31369010717213
  name:  Home Assistant Connect ZBT-2 Device overview
  position: 20
  labels: connect-zbt-2, about-the-device
---

![Image of device with labeled parts: status light, antenna, base, USB-C port, and reset button](/static/img/connect-zbt-2/zbt-2-device-overview.png)
