...
2. In the Remote Access section, expand the “Security Options” and view the “Certificate Information”
3. Take note of the Remote Access URL and “Certificate fingerprint”
4. Now visit a certificate search site like [crt.sh](https://crt.sh/)
5. Put in your Remote Access URL into the search (it will end with ui.nabu.casa)
6. Then check if the fingerprint matches the “SHA-1” number listed on the latest certificate
