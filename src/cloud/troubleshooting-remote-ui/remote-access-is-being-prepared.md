...
1. Download and attach the support package file using the 3 dots in the upper right corner of the Home Assistant Cloud page in the Home Assistant settings.
